# TOOLS.md — every OSS tool registered for FactoryMind

This file is the single inventory of every OSS tool wired up for FactoryMind.
...
| messaging | [eclipse-sparkplug](messaging/eclipse-sparkplug/) | `messaging/eclipse-sparkplug/` (scaffold) |
...
| domain-oss | [eclipse-basyx](domain-oss/eclipse-basyx/) | `domain-oss/eclipse-basyx/` (deployable) |
| domain-oss | [plc4x](domain-oss/plc4x/) | `domain-oss/plc4x/` (deployable) |
