...
default_args = { "owner": "factorymind-data", "retries": 2, "retry_delay": timedelta(minutes=5) }
with DAG("factorymind_daily_etl", start_date=datetime(2026, 1, 1), schedule_interval="0 2 * * *", default_args=default_args, catchup=False) as dag:
